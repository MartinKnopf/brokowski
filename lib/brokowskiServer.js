...
module.exports = BrokowskiServer;
...
BrokowskiServer.prototype.start = function() {
  ...
  this.server.listen(self.options.port || 3000, function() {
    console.log('starting brokowski server ' + JSON.stringify({pid: process.pid, port: self.options.port || 3000}));
  });
}
